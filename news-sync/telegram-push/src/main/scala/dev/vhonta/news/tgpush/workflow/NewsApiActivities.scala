...
object NewsApiActivitiesImpl {
  val make: URLayer[NewsApiClient with NewsFeedIntegrationRepository with ZActivityOptions[Any], NewsApiActivities] =
    ZLayer.fromFunction(
      NewsApiActivitiesImpl(_: NewsApiClient, _: NewsFeedIntegrationRepository)(_: ZActivityOptions[Any])
    )
}
