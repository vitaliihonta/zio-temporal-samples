...
import dev.vhonta.news.tgpush.workflow.ScheduledPushRecommendationsWorkflow
...
object ScheduledPushStarter {
  val TaskQueue   = "news-telegram-push"
  val SchedulerId = "news-telegram-scheduled-push"
